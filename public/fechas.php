...
<nav class="navbar">
    <div class="nav-container">
        ...
        <ul class="nav-links">
            ...
            <li><a href="fechas.php" class="active">PRÓXIMAS FECHAS</a></li>
...
<script>
    async function loadAllEvents() {
        try {
            const response = await fetch('api/get_all.php?t=' + Date.now());
            ...
            eventosFuturos.forEach(event => {
                ...
                const urlCompra = `compra.php?fiesta=${encodeURIComponent(titulo)}&img=${encodeURIComponent(event.image)}`;
                ...
                grid.innerHTML += `
                    <div class="flyer-card">
                        ...
                        <div style="padding: 0 10px 20px 10px; text-align: center;">
                            <a href="${urlCompra}" class="btn-ticket">COMPRAR ENTRADA</a>

                            <a href="reservas.php?evento=${encodeURIComponent(titulo)}"
